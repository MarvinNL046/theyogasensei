...
export function DoubleOptIn({ confirmUrl, leadMagnet }: DoubleOptInProps) {
  return (
    <Html>
      <Head />
      <Preview>One click to confirm your subscription to The Yoga Sensei.</Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          <Text style={styles.body_text}>
            Thanks for subscribing to The Yoga Sensei. Confirm your email and we will start
            sending the weekly practice update.
            {leadMagnet
          ...
          <Hr style={styles.hr} />
          <Text style={styles.fine}>
            You are receiving this because someone entered your email at theyogasensei.com. If
            that was not you, ignore this email — without confirmation, nothing happens.
          </Text>
