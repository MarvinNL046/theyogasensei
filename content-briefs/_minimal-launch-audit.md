...
- No content/reviews/*, content/styles/*, content/gear/*, content/blog/* exist.

## Section 1 — Inventory with Minimal Launch classification

| Path | Current state | New classification | Why |
|---|---|---|---|
| __root.tsx | Layout shell (Header/Footer + outlet) | KEEP-LIVE | Required infrastructure; not a URL. |
