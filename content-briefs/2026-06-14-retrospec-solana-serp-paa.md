# SERP + PAA Analysis — "retrospec solana yoga mat"

**Date:** 2026-06-14 · **Page:** `/guides/retrospec-solana-yoga-mat` · **Status:** published (research-based review)
**Target:** retrospec solana yoga mat · vol 14,000 · KD 2 · commercial intent

---

## SERP landscape (what ranks now)

The page-1 results for "retrospec solana yoga mat review" are:

- **Amazon** (product + 2 Amazon Live "honest review" videos)
- **Aggregators** — bestviewsreviews.com (69% positive / 25% negative sentiment), Gigabrain (vs BalanceFrom)
- **Thin affiliate blogs** — gicandoyoga (separate ½" + 1" posts), exercisegymforhome, yogaframework, mattersofmymind, outdoorjournal, melanatedcampout
...
4. **Honest "who should skip it"** — hot yoga + balance practitioners steered away rather than sold to.
...
- [Retrospec Solana ½" official](https://retrospec.com/products/solana-5-yoga-mat) · [Solana 1" official](https://retrospec.com/products/solana-yoga-mat)
- [Wirecutter best yoga mat](https://www.nytimes.com/wirecutter/reviews/best-yoga-mat/) (premium testers, for contrast)
- Prop 65: [Mamavation yoga mats](https://mamavation.com/health/yoga-mats-best-for-environment.html) · [Scienceline](https://scienceline.org/2020/10/why-my-yoga-mat-scared-me-and-what-i-did-about-it/) · [htsyoga Prop 65 guide](https://htsyoga.com/yoga-mat-warning-labels-explained-prop-65-materials-and-what-buyers-should-check/) · [official p65warnings.ca.gov](https://www.p65warnings.ca.gov/)
- Cross-shop: BalanceFrom 1" extra-thick (Amazon B0CJQFZRYK)
