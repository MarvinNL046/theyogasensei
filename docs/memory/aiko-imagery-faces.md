...
For Aiko hero/pin imagery, Marvin's stated preference (2026-05-29):
**visible faces are fine — cropped/cut-off heads look worse and he dislikes them.**
...
frame (not cut off at the crop). Decorative use is fine. AND always eyeball anatomy
before shipping — the first bad-knees hero shipped with an extra-leg artifact
(cross-legged + bolster); generate a few candidates and pick a clean, anatomically
correct one. See [[aiko-soul-id]] for the Soul ref and generation workflow.
