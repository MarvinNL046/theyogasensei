...
function BoldLayout(
  ...
  return h(
            ...
            h(
              'div',
              {
                style: {
                  ...
                  color: CREAM,
                  fontFamily: 'Anton',
                  fontSize: Math.round(titleSize * 0.78),
                  lineHeight: 1.0,
                  textTransform: 'uppercase',
    ...
    h('div', {
      style: { width: W, height: H - BOLD_TOP - BOLD_BAR, display: 'flex' },
    }),
    // ---- CTA bar ----
    h(
      'div',
...
function StructuredLayout(
  ...
  return h(
    ...
    h('div', {
      style: { width: W, height: H - STRUCT_TOP - STRUCT_BAR, display: 'flex' },
    }),
...
function PinLayout(
  ...
  if (style === 'structured')
    return StructuredLayout(eyebrow, title, subtitle, titleSize)
...
async function renderPin(
  ...
  const size =
    titleSize ?? (style === 'bold' ? 104 : style === 'structured' ? 68 : 86)
  const svg = await satori(
    PinLayout(eyebrow, title, subtitle, size, style) as any,
    { width: W, height: H, fonts, embedFont: true },
  )
  ...
  const bg = await sharp(resolve(ROOT, image))
...
const GUIDES: Guide[] = [
  {
    ...
    hooks: [
      [
        'Buying Guide',
        'How to Choose a Yoga Mat, Without the Hype',
        'Thickness, material, grip and care, explained plainly.',
        78,
      ],
      [
        'Common Problem',
        'Buying the Wrong Mat Is Easy. Here Is How to Avoid It',
        'The five things that actually decide a good mat.',
        72,
      ],
      [
        'At a Glance',
        'Thickness, Material, Grip: What Actually Matters',
        'A simple way to compare any yoga mat.',
        80,
      ],
      ['The Yoga Sensei', 'The Only Yoga Mat Guide You Need', '', 88],
      [
        'Before You Buy',
        '5 Questions to Ask Before You Buy a Yoga Mat',
        'Save money. Skip the regret.',
        74,
      ],
    ],
  },
  {
    ...
    hooks: [
      [
        'Gear Guide · 2026',
        'The Honest Yoga Mat Guide for 2026',
        'Real picks for every body and budget, and when not to buy.',
        86,
      ],
      [
        'Buying Guide',
        'Wobbly, Slippy, or Too Thin?',
        'How to pick a yoga mat that lasts years, not months.',
        92,
      ],
      [
        'Mat Comparison',
        'Thick vs Thin: Which Mat Suits You?',
        'A simple guide to thickness, grip and material.',
        80,
      ],
      ['The Yoga Sensei', 'The Only Yoga Mat Guide You Need', '', 88],
      [
        'Before You Buy',
        '5 Things to Check Before You Buy a Yoga Mat',
        'Save money. Skip the regret.',
        74,
      ],
    ],
  },
  {
    ...
    hooks: [
      [
        ...
        'From 3mm to 10mm, and who each one is for.',
        84,
      ],
      [
        'Common Problem',
        'Sore Knees or No Balance? It Might Be the Thickness',
        'The cushion-versus-stability trade-off, explained.',
        72,
      ],
      [
        'At a Glance',
        '3mm vs 5mm vs 6mm vs 10mm',
        'Pick the right thickness for how you practise.',
        86,
      ],
      ['The Yoga Sensei', 'The Right Mat Thickness for Your Practice', '', 84],
      [
        'Before You Buy',
        'The Thickness Mistake Most Beginners Make',
        'More cushion is not always better.',
        76,
      ],
    ],
  },
  {
    ...
    hooks: [
      [
        ...
        'Cushion without the wobble. Three honest picks.',
        84,
      ],
      [
        'Common Problem',
        'Knees Hurt in Yoga? Start With the Mat',
        'Cushion, stability and cheaper fixes to try first.',
        76,
      ],
      [
        'At a Glance',
        'Cushion vs Stability for Sensitive Knees',
        'How to get both without the sink-in feeling.',
        80,
      ],
      ['The Yoga Sensei', 'A Kinder Mat for Sensitive Knees', '', 86],
      [
        'Before You Buy',
        'Try This Before You Buy a Thicker Mat',
        'The cheap fix for sore knees most people miss.',
        74,
      ],
    ],
  },
  {
    ...
    hooks: [
      [
        ...
        'Grip that survives the sweat.',
        90,
      ],
      [
        'Common Problem',
        'Sliding Around in Hot Yoga?',
        'Wet grip, sweat handling and the towel question.',
        84,
      ],
      [
        'At a Glance',
        'What Makes a Mat Grip When You Sweat',
        'Material, texture and the right towel pairing.',
        78,
      ],
      ['The Yoga Sensei', 'A Mat That Holds Up to the Heat', '', 86],
      [
        'Before You Buy',
        'The Hot Yoga Grip Fix You Already Own',
        'Why a towel beats a pricier mat, sometimes.',
        74,
      ],
    ],
  },
  {
    ...
    hooks: [
      ...
      [
        'Common Problem',
        'Slipping in Downward Dog?',
        'Read what actually grips',
        68,
      ],
      [
        'At a Glance',
        'PU vs Rubber vs Foam: Which Grips Best?',
        'See the comparison',
        60,
      ],
      ...
      [
        'Before You Buy',
        '5 Free Fixes for a Slippery Yoga Mat',
        'Get the fixes',
        62,
      ],
    ],
  ...
  },
  {
    ...
    hooks: [
      ...
      [
        'The Yoga Sensei',
        'Care for the Mat You Splurged On',
        'Read the guide',
        62,
      ],
      [
        'Before You Clean',
        'Skip the Vinegar on This Mat',
        'Read why first',
        64,
      ],
    ],
  ...
  },
  {
    ...
    hooks: [
      ...
      [
        'Which One?',
        'Sweaty Hands or Dry? That Changes the Answer',
        'Cork, rubber and the latex question.',
        76,
      ],
      [
        'At a Glance',
        'Cork vs Rubber: Grip, Weight, Care, Eco',
      ...
      [
        'Quick Tip',
        'Latex-Sensitive? Read This First',
        'One reason rubber might not be for you.',
        78,
      ],
    ],
  },
  {
    ...
    hooks: [
      [
        ...
        'Five honest picks, and the real material trade-offs.',
        84,
      ],
      [
        'Common Problem',
        '"Eco" on the Label Does Not Always Mean Greener',
        'How to read past the marketing.',
        72,
      ],
      [
        'At a Glance',
        'Cork, Rubber, Jute, TPE: The Eco Trade-Offs',
        'Grip, care and latex risk compared.',
        76,
      ],
      ['The Yoga Sensei', 'A Greener Mat, Honestly Chosen', '', 86],
      [
        'Before You Buy',
        'The Greenest Mat Is the One You Keep',
        'Why durability beats the eco label.',
        74,
      ],
    ],
  },
  {
    ...
    hooks: [
      [
        'Gear Guide',
        'Best Yoga Blocks: Foam vs Cork',
        'Three honest picks for support, balance and budget.',
        84,
      ],
      [
        'Common Problem',
        'Cannot Reach the Floor? A Block Fixes That',
        'How blocks make poses work for your body.',
        76,
      ],
      [
        'At a Glance',
        'Foam vs Cork Yoga Blocks',
        'Weight, grip and firmness, compared.',
        86,
      ],
  ...
  },
  {
    ...
    hooks: [
      [
        'Gear Guide',
        'Best Yoga Bolsters',
        'Shapes, fills and two honest picks.',
        90,
      ],
      [
        'Common Problem',
        'Restorative Yoga Feels Better With a Bolster',
        'How the right shape supports real rest.',
        76,
      ],
      [
        'At a Glance',
        'Rectangular vs Round Bolster',
        'Which shape suits your practice.',
        82,
      ],
      ['The Yoga Sensei', 'The Prop That Makes Rest Easier', '', 86],
      [
        'Before You Buy',
        'Firm or Soft? Pick the Right Fill',
        'The choice that decides how it feels.',
        76,
      ],
    ],
  },
  {
    ...
    hooks: [
      [
        'Gear Guide',
        'Best Yoga Mat Bags and Carriers',
        'A practical guide, and two honest picks.',
        82,
      ],
      [
        'Common Problem',
        'Will Your Mat Actually Fit the Bag?',
        'How to check before you buy.',
        80,
      ],
      [
        'At a Glance',
        'Bag vs Sling vs Carrier',
        'Which one fits how you travel to class.',
        84,
      ],
      ...
      [
        ...
        'When a simple sling does the job.',
        76,
      ],
    ],
  },
  {
    ...
    hooks: [
      [
        ...
        'Without damaging it. A simple routine.',
        88,
      ],
      [
        'Common Problem',
        'Smelly or Slippery Mat? Here Is the Fix',
        'Daily wipe-downs and the right deep clean.',
        76,
      ],
      [
        'Quick Guide',
        'The DIY Mat Spray That Actually Works',
        'And the cleaners that quietly ruin mats.',
        78,
      ],
      ['The Yoga Sensei', 'Keep Your Mat Fresh, the Gentle Way', '', 86],
      [
        'Avoid This',
        'The Cleaning Mistake That Wrecks Mats',
        'What not to use on rubber, cork and TPE.',
        76,
      ],
    ],
  },
  {
    ...
    hooks: [
      [
        'Care Guide',
        'How to Store a Yoga Mat So It Lasts',
        'Roll it right, keep it fresh.',
        84,
      ],
      [
        'Common Problem',
        'Curling Corners and Musty Smells?',
        'The storage habits that cause both.',
        78,
      ],
      [
        'Quick Guide',
        'Roll It Practice-Side In, and Three More Tips',
        'Small habits that add years to a mat.',
        76,
      ],
      ['The Yoga Sensei', 'A Mat That Lasts Starts With Storage', '', 86],
      [
        'Avoid This',
        'Sun and Damp Are Quietly Killing Your Mat',
  ...
  },
  {
    ...
    hooks: [
      [
        'Honest Review',
        'Lululemon Yoga Mat: Worth It?',
        'The grip, the 5mm cushion, and the catches.',
        84,
      ],
      [
        'Worth It?',
        'Everyone Loves the Grip. Here Is the Catch',
        'Weight, stains and latex, honestly.',
        76,
      ],
      [
        'Pros & Cons',
        'The Lululemon Mat, Honestly',
        'What it nails, and what it does not.',
        84,
      ],
      ['The Yoga Sensei', 'Is the Lululemon Mat Right for You?', '', 86],
      [
        'Who Should Skip',
        'Three Reasons to Skip This Mat',
  ...
  },
  {
    ...
    hooks: [
      [
        'Honest Review',
        'Retrospec Solana: Cushion vs Stability',
        'Brilliant for sore knees, wobbly for balance.',
        80,
      ],
      [
        'Common Problem',
        'Sore Knees on a Thin Mat?',
        'Why thick foam helps, and where it does not.',
        78,
      ],
      [
        'At a Glance',
        'Half Inch vs One Inch: Which Solana?',
        'Cushion, balance and what each is for.',
        80,
      ],
      ['The Yoga Sensei', 'Is the Retrospec Solana Right for You?', '', 84],
      [
        'Who Should Skip',
        'Three Reasons to Skip This Budget Mat',
        'Hot yoga, balance, and one label to check.',
        74,
      ],
    ],
  },
  {
    ...
    hooks: [
      [
        'Honest Review',
        'Manduka: Which Mat Is Right for You?',
        'PRO vs eKO vs GRP, decoded honestly.',
        82,
      ],
      [
        'Common Problem',
        'Bought the Famous Manduka? It Might Be Wrong',
        'The PRO is not the right pick for everyone.',
        74,
      ],
      [
        'At a Glance',
        'Manduka PRO vs eKO vs GRP',
        'Durability, eco, or hot-yoga grip — pick one.',
        84,
      ],
      ['The Yoga Sensei', 'The Lifetime Mat, Honestly Reviewed', '', 86],
      [
        'Before You Buy',
        'The Manduka Break-In Nobody Warns You About',
        'Why a new PRO feels slippery, and what helps.',
        74,
      ],
    ],
  },
  {
    ...
    hooks: [
      [
        'Honest Review',
        'Gaiam Yoga Mat: Best Budget Beginner Mat?',
        'Real cushion, low price, a few catches.',
        78,
      ],
      [
        'Common Problem',
        'New to Yoga and Overwhelmed by Mats?',
        'Why the cushioned Gaiam is an easy first pick.',
        76,
      ],
      [
        'At a Glance',
        'Is the Gaiam Premium Worth It?',
        'Cushion, style and price vs the compromises.',
        82,
      ],
      ['The Yoga Sensei', 'The Best First Yoga Mat on a Budget?', '', 84],
      [
        'Who Should Skip',
        'Three Reasons the Gaiam Is Not for You',
        'Hot yoga, tall frames, and the initial smell.',
        76,
      ],
    ],
  },
  {
    ...
    hooks: [
      [
        'Comparison',
        'Manduka vs Lululemon: Which Mat Wins?',
        'Grip, latex, durability and price, honestly.',
        80,
      ],
      [
        'Which One?',
        'Grip Now or a Mat for Life?',
        'The real difference between Manduka and Lululemon.',
        76,
      ],
      [
        'At a Glance',
        'Manduka PRO vs Lululemon The Mat',
        'Latex, break-in, staining and lifespan compared.',
        80,
      ],
      ['The Yoga Sensei', 'Manduka or Lululemon? A Clear Answer', '', 86],
      [
        'Quick Tip',
        'Latex-Sensitive? This Decides It Instantly',
        'One mat is latex-free, the other is not.',
        78,
      ],
    ],
  },
  {
    ...
    hooks: [
      [
        'Honest Review',
        'Jade Harmony: The Grippiest Eco Mat?',
        'Best-in-class dry grip, with one real catch.',
        80,
      ],
      [
        'Common Problem',
        'Sliding Around on Your Mat?',
        'Why natural-rubber grip fixes it — and when it does not.',
        74,
      ],
      [
        'At a Glance',
        'Jade Harmony: Grip, Eco, Latex',
        'What the teacher-favourite gets right and wrong.',
        82,
      ],
      ['The Yoga Sensei', 'Is the Jade Harmony Right for You?', '', 84],
      [
        'Quick Tip',
        'Love the Grip? Avoid It for Hot Yoga',
        'Open-cell rubber drinks sweat and turns slick.',
        76,
      ],
    ],
  },
  ...
  // hooks. Copy is 12-year-old readable, honest, "educational not medical".
  {
    ...
    hashtags:
      '#chairyoga #chairyogaforseniors #gentleyoga #yogaforseniors #seniorfitness',
    ...
    hooks: [
      [
        'Chair Yoga',
        'Chair Yoga for Seniors: 12 Gentle Poses',
        'A safe, seated way to move more — no floor needed.',
        74,
      ],
      [
        'Gentle Movement',
        'Hard to Get Down to the Floor?',
        'Chair yoga keeps you moving, safely seated.',
        80,
      ],
      [
        'At a Glance',
        'A Safe 10-Minute Chair Yoga Routine',
        'Twelve gentle poses, in a calm order.',
        80,
      ],
      ['The Yoga Sensei', 'A Kinder Way to Move', '', 88],
      [
        'Before You Start',
        'Chair Yoga Safety, the Honest Way',
        'When to take it easy, and when to ask your doctor.',
        74,
      ],
    ],
  },
  {
    ...
    hashtags:
      '#chairyoga #chairyogaforbeginners #beginneryoga #gentleyoga #accessibleyoga',
    ...
    hooks: [
      [
        'Beginner Guide',
        'Chair Yoga for Beginners: 6 Easy Poses',
        'Start seated, keep it small, build from there.',
        76,
      ],
      [
        'New to Yoga?',
        'Floor Classes Feel Too Hard?',
        'Chair yoga is the easiest way to begin.',
        82,
      ],
      [
        'At a Glance',
        'A Simple 5-Minute Chair Yoga Routine',
        'Six gentle poses to link together.',
        80,
      ],
      ['The Yoga Sensei', 'An Easy Way to Start Yoga', '', 88],
      [
        'Before You Start',
        '5 Beginner Chair Yoga Mistakes to Avoid',
        'Small and gentle beats big and forced.',
        74,
      ],
    ],
  },
  {
    ...
    hashtags:
      '#chairyoga #freeyoga #chairyogaforseniors #yogaforseniors #gentleyoga',
    ...
    bg: Array(5).fill(
      'public/images/guides/free-chair-yoga-for-seniors/pin.webp',
    ),
    hooks: [
      [
        'Free at Home',
        'Free Chair Yoga for Seniors',
        'A short routine you can do today — no class needed.',
        78,
      ],
      [
        'No Budget?',
        'Chair Yoga Costs Nothing to Start',
        'All you need is a sturdy chair you already own.',
        78,
      ],
      [
        'Where to Look',
        'Where to Find Free Chair Yoga',
        'Libraries, community centres and safe videos.',
        80,
      ],
      ['The Yoga Sensei', 'Gentle Movement, Free', '', 88],
      [
        'Stay Safe',
        'How to Pick a Safe Free Routine',
        'What a good instructor always shows you.',
        74,
      ],
    ],
  },
  {
    ...
    hashtags:
      '#chairyoga #printableyoga #chairyogaforseniors #yogaforseniors #gentleyoga',
    ...
    bg: Array(5).fill(
      'public/images/guides/printable-chair-yoga-for-seniors/pin.webp',
    ),
    hooks: [
      [
        'Printable Chart',
        'Printable Chair Yoga for Seniors',
        'A simple chart to print and keep by the chair.',
        76,
      ],
      [
        'Easy to Follow',
        'Hard to Remember the Poses?',
        'A large-step printed chart keeps it simple.',
        80,
      ],
      [
        'At a Glance',
        'The Whole Routine on One Page',
        'Clear steps, big text, easy to follow.',
        82,
      ],
      ['The Yoga Sensei', 'Keep the Routine Within Reach', '', 88],
      [
        'How to Use It',
        'Print It, Keep It by the Chair',
        'A few tips to get the most from the chart.',
        76,
      ],
    ],
  },
  // Mindful Living board — pose page (route /poses/, calm Aiko imagery, no guide folder).
  {
    ...
    route: 'poses',
    hashtags:
      '#childspose #balasana #restorativeyoga #yogaforbeginners #mindfulliving',
    ...
    hooks: [
      [
        'Mindful Living',
        "Child's Pose: How to Truly Rest",
        'The calming shape you can return to any time.',
        82,
      ],
      [
        'Common Problem',
        "Can't Sit Back on Your Heels?",
        'Tight hips are normal. Let a prop bring the floor up.',
        76,
      ],
      [
        'How To',
        "Child's Pose, Step by Step",
        'Beginner cues, common mistakes, and the right props.',
        84,
      ],
      ['The Yoga Sensei', 'A Calmer Way to Pause', '', 88],
      [
        'Take It Easy',
        "When to Skip Child's Pose",
        'Knee injury and late pregnancy: gentler options.',
        78,
      ],
    ],
  },
  ...
  // Each has a single on-brand portrait pin.webp, so bg fills all five angles to it.
  {
    ...
    route: 'poses',
    hashtags:
      '#sunsalutation #suryanamaskar #yogaforbeginners #morningyoga #yogaflow',
    ...
    hooks: [
      [
        'How To',
        'Sun Salutation A: All 12 Steps for Beginners',
        'The breath, the order, and the common mistakes.',
        72,
      ],
      [
        'New to It?',
        'Lost in Your First Sun Salutation?',
        'One breath, one move — the calm way to learn it.',
        80,
      ],
      [
        'At a Glance',
        'Sun Salutation A, Step by Step',
        'The 12-pose flow at the heart of every class.',
        82,
      ],
      ['The Yoga Sensei', 'Begin the Day With Sun Salutation', '', 88],
      [
        'Before You Flow',
        'Sun Salutation: 5 Beginner Mistakes to Avoid',
        'Slow the breath, bend the knees, skip the rush.',
        72,
      ],
    ],
  },
  {
    ...
    route: 'poses',
    hashtags:
      '#sunsalutationb #suryanamaskar #vinyasa #yogaforbeginners #yogaflow',
    ...
    hooks: [
      [
        'How To',
        'Sun Salutation B: The Full 17-Step Flow',
        'Chair Pose, Warrior I, and the breath that links them.',
        70,
      ],
      [
        'Ready for More?',
        'Mastered Sun Salutation A?',
        'Sun Salutation B is the stronger next step.',
        82,
      ],
      [
        'At a Glance',
        'Sun Salutation A vs B',
        'What B adds, and when to move up.',
        88,
      ],
      ['The Yoga Sensei', 'A Stronger Sun Salutation', '', 88],
      [
        'Watch For',
        'Sun Salutation B: 5 Common Mistakes',
        'Knees down, breath slow, Warrior I steady.',
        72,
      ],
    ],
  },
  {
    ...
    route: 'poses',
    hashtags:
      '#sunsalutationc #suryanamaskar #yogaforbeginners #gentleyoga #vinyasa',
    ...
    hooks: [
      [
        'How To',
        'Sun Salutation C: A Gentler Flow',
        'Low lunges and Cobra instead of Chaturanga.',
        78,
      ],
      [
        'Sore Wrists?',
        'A Sun Salutation Kinder on the Wrists',
        'Sun Salutation C skips the hard push-ups.',
        78,
      ],
      [
        'At a Glance',
        'Sun Salutation A, B and C',
        'How the three flows differ — and which to pick.',
        82,
      ],
      ['The Yoga Sensei', 'A Calm, Grounding Sun Salutation', '', 88],
      [
        'Good to Know',
        'Sun Salutation C, Step by Step',
        'The gentle salutation, explained simply.',
        80,
      ],
    ],
  },
  {
    ...
    hashtags:
      '#morningyoga #yogaforbeginners #morningroutine #yogaflow #yogaposes',
    ...
    hooks: [
      [
        'Morning Routine',
        'A Gentle 10-Minute Morning Yoga Routine',
        'Eight simple poses to wake up the body.',
        74,
      ],
      [
        'New to Yoga?',
        'Start Your Day With 10 Minutes of Yoga',
        'A calm, beginner-friendly morning flow.',
        78,
      ],
      [
        'At a Glance',
        '5, 15 or 30 Minutes of Morning Yoga',
        'The same gentle flow, any length you like.',
        80,
      ],
      ...
      [
        ...
        'Small, daily, and easy to keep up.',
        76,
      ],
    ],
  },
  ...
  // opt-in (captures an email) rather than a content page. Full URL override.
  {
    ...
    hooks: [
      [
        'Free PDF Guide',
        'The Free Yoga for Beginners Starter Guide',
        'Gear, eight poses, and a 10-minute morning routine.',
        74,
      ],
      [
        'New to Yoga?',
        'Starting Yoga Feels Like a Lot. It Does Not Have To.',
        'One free guide: what to buy, what to do, where to begin.',
        74,
      ],
      [
        'What Is Inside',
        'Everything a Beginner Needs, in One Free Guide',
        'The gear, the poses, the morning routine.',
        76,
      ],
      ['The Yoga Sensei', 'Start Yoga, the Calm Way', '', 92],
      [
        'Free Download',
        '8 Poses, 1 Routine, the Right Gear',
        'Grab the free beginner starter guide.',
        80,
      ],
    ],
  },
  ...
  // rendered in the 'darkred' charcoal+red variant to compare engagement vs the olive pins.
  {
    ...
    style: 'darkred',
    hashtags:
      '#yogamat #bestyogamats #yogagear #yogaforbeginners #yogaessentials',
    ...
    hooks: [
      [
        'Gear Guide · 2026',
        'The Honest Yoga Mat Guide for 2026',
        'Seven picks for every body and budget — and when not to buy.',
        82,
      ],
      [
        'Before You Buy',
        'Wobbly, Slippy or Too Thin?',
        'How to pick a mat that lasts years, not months.',
        88,
      ],
      [
        'At a Glance',
        'Thick vs Thin: Which Mat Suits You?',
        'Grip, cushion and material, compared honestly.',
        82,
      ],
      ['The Yoga Sensei', 'The Only Yoga Mat Guide You Need', '', 90],
      [
        '7 Honest Picks',
        '7 Yoga Mats Worth Your Money',
        'From budget to buy-it-for-life.',
        84,
      ],
    ],
  },
  {
    ...
    hooks: [
      ...
      [
        'Ranked by grip',
        'Non Slip\nYoga Mats',
        'Which mats actually stay put',
        112,
      ],
      [
        'Worth the money',
        'Yoga Mats',
        'No fake lab tests. Sources cited.',
        116,
      ],
    ],
  },
  {
    ...
    hooks: [
      [
        'Ranked by wet grip',
        'Hot Yoga\nMats',
        '4 mats that hold when you sweat',
        112,
      ],
      ['For hot yoga', 'Best\nYoga Mat', 'Grip that survives the sweat', 112],
      [
        'Do you need one?',
        'Hot Yoga\nTowel',
        'Sometimes it beats a pricier mat',
        112,
      ],
      [
        'Fix the grip',
        'Sliding In\nHot Yoga?',
        'Why your mat gives up when wet',
        104,
      ],
      [
        'Make it last',
        'Hot Yoga\nMat Care',
        'Clean it right or it dies fast',
        112,
      ],
    ],
  },
  {
    ...
    hooks: [
      [
        '5 honest picks',
        'Eco Friendly\nYoga Mats',
        'The material trade-offs, explained',
        100,
      ],
      [
        'Worth it?',
        'Cork\nYoga Mats',
        'Grip, care and the real trade-off',
        116,
      ],
      [
        'Best grip',
        'Natural Rubber\nYoga Mats',
        'And the latex warning to read first',
        92,
      ],
      [
        'Read the label',
  ...
  // Affiliate spoke + remaining beginner pose pages (hooks QA'd via workflow).
  {
    ...
    hashtags:
      '#yogamat #yogaforbeginners #beginneryoga #yogagear #yogaessentials',
    ...
    bg: Array(5).fill(
      'public/images/guides/best-yoga-mat-for-beginners/pin.webp',
    ),
    hooks: [
      [
        'Gear Guide',
        'Best Yoga Mat for Beginners, by Budget',
        'Five honest picks, from cheap-and-cheerful to buy-it-for-life.',
        76,
      ],
      [
        'New To Yoga',
        'Your Mat Keeps Sliding? Start Here',
        "Why cheap foam wobbles, and the beginner mats that don't.",
        82,
      ],
      [
        'At a Glance',
        '5 Beginner Yoga Mats Compared',
        'Thickness, grip and latex flags, side by side.',
        84,
      ],
      ...
      [
        ...
        "4 to 6mm is the sweet spot. Here's why.",
        78,
      ],
    ],
  },
  {
    ...
    route: 'poses',
    hashtags:
      '#downwarddog #downwardfacingdog #yogaforbeginners #yogaposes #adhomukhasvanasana',
    ...
    hooks: [
      [
        ...
        'Six calm beginner cues that actually matter.',
        80,
      ],
      [
        'Common Problem',
        "You're Overthinking Downward Dog",
        "You don't need flat heels or straight legs.",
        84,
      ],
      [
        'At a Glance',
        'Downward Dog: What Really Matters',
        'A straight back beats straight legs, every time.',
        82,
      ],
      ['The Yoga Sensei', 'One Long, Easy Breath Upside Down', '', 82],
      [
        'Take It Easy',
        'When to Go Gentle in Downward Dog',
        'Sore wrists, carpal tunnel, late pregnancy.',
        80,
      ],
    ],
  },
  {
    ...
    route: 'poses',
    hashtags:
      '#warrior2 #warriorii #virabhadrasana #yogaforbeginners #yogaposes',
    ...
    hooks: [
      [
        ...
        'Set the feet, stack the knee, reach long.',
        86,
      ],
      [
        'Common Problem',
        'Why Your Front Knee Hurts in Warrior II',
        'It is almost always alignment. Here is the fix.',
        74,
      ],
      [
        'At a Glance',
        'Warrior II at a Glance',
        'Targets, hold time, and props in one quick look.',
        88,
      ],
      ['The Yoga Sensei', 'Strong Legs, Soft Gaze', '', 90],
      [
        'Take It Easy',
        '4 Warrior II Mistakes to Avoid',
        'Knee caving, sliding past the ankle, and more.',
        82,
      ],
    ],
  },
  {
    ...
    hooks: [
      [
        ...
        'Lift from your back, keep the hands light.',
        86,
      ],
      [
        'Common Problem',
        'Why Cobra Pose Hurts Your Lower Back',
        "You're lifting too high. Here's the gentler fix.",
        76,
      ],
      [
        'At a Glance',
        'Cobra vs. Baby Cobra vs. Sphinx',
        'Three gentle backbends, from softest to fuller.',
        80,
      ],
      ['The Yoga Sensei', 'A Quiet Opening for the Chest', '', 86],
      [
        'Take It Easy',
        'When to Skip Cobra Pose',
        'Back injury and pregnancy: kinder options instead.',
        88,
      ],
    ],
  },
  {
    ...
    route: 'poses',
    hashtags:
      '#pigeonpose #hipopener #yogaforbeginners #yogaposes #ekapadarajakapotasana',
    ...
    hooks: [
      [
        ...
        'Beginner cues to open tight hips without hurting the knee.',
        82,
      ],
      [
        'Common Problem',
        'Tight Hips in Pigeon Pose?',
        'Why your hip floats off the mat, and the prop that fixes it.',
        88,
      ],
      [
        'At a Glance',
        'Pigeon Pose vs. the Figure-4',
        'Same deep hip stretch, no weight on the knee.',
        82,
      ],
      ['The Yoga Sensei', 'A Slow Opening for the Hips', '', 86],
      [
        'Take It Easy',
        'Pigeon Pose Sore? Read This First',
        'Knee, hip, or SI pain and pregnancy: gentler options.',
        80,
      ],
    ],
  },
...
async function main() {
  ...
  for (let g = 0; g < GUIDES.length; g++) {
    ...
    const url =
      guide.url ??
      `https://www.theyogasensei.com/${guide.route ?? 'guides'}/${guide.slug}`
    const lines: string[] = [
