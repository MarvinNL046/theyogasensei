...
const SEARCH_ITEMS: Array<SearchItem> = [
  {
    ...
    excerpt:
      'A gentle full-body flow to wake up your body, clear your mind and set a positive tone.',
  ...
  },
  {
    ...
    excerpt:
      'Discover how a morning practice can support your energy, focus and overall well-being.',
    href: '/guides/morning-yoga-routine',
  ...
  },
  {
    ...
    excerpt:
      'Build strength, improve flexibility and boost energy with this complete morning sequence.',
    href: '/guides/morning-yoga-routine',
  ...
  },
  {
    ...
    excerpt:
      'How a slower, more intentional morning can transform your day from the inside out.',
  ...
  },
  {
    ...
    excerpt:
      'Grip, comfort and support to help you feel grounded in every morning flow.',
  ...
  },
  {
    ...
    excerpt:
      'Pick a style, learn foundational poses and build a simple practice without overwhelm.',
  ...
  },
  {
    ...
    excerpt:
      'A practical buying guide for choosing your first mat without overspending.',
  ...
  },
  {
    ...
    excerpt:
      'A focused review of grip, cushioning, durability and who this premium mat suits best.',
  ...
  },
  {
    ...
    excerpt:
      'Simple breathing techniques for steady attention, calmer transitions and better practice.',
  ...
  },
  {
    ...
    excerpt:
      'A quiet evening sequence with longer holds, simple props and a slower pace.',
  ...
  },
  {
    ...
    excerpt:
      'A calm comparison to help you choose the right block for alignment, support and travel.',
    href: '/gear',
  ...
  },
  {
    ...
    excerpt:
      'Why five minutes done often beats a perfect twenty-minute sit done once.',
  ...
  },
  {
    ...
    excerpt:
      'A simple step-by-step path for building confidence, consistency and connection.',
    href: '/start-here',
    image: '/images/brand/review-hero-best-mats.webp',
    type: 'Guides',
    label: 'Start Here',
  ...
  },
  {
    ...
    excerpt:
      'Handpicked tools that support a mindful practice, on and off the mat.',
    href: '/sensei-picks',
    image: '/images/brand/review-hero-best-mats.webp',
    type: 'Product Reviews',
    label: 'Sensei Picks',
  ...
  },
  {
    ...
    excerpt:
      'Explore mats, blocks, straps, bolsters and practical tools for long-term practice.',
    href: '/gear',
    image: '/images/brand/review-hero-best-mats.webp',
    type: 'Guides',
    label: 'Category',
  ...
  },
  {
    ...
    excerpt:
      'Weekly insights, practice notes and grounded reflections for a more mindful life.',
    href: '/mindful-journal',
    image: '/images/brand/journal-hero-bg.webp',
    type: 'Journal Articles',
    label: 'Journal',
...
function SearchPage() {
  ...
  const [contentType, setContentType] = useState<'All Results' | ContentType>(
    'All Results',
  )
  ...
  const filteredResults = useMemo(() => {
    const filtered = scoredResults.filter(({ item }) => {
      if (contentType !== 'All Results' && item.type !== contentType)
        return false
      if (categories.length > 0 && !categories.includes(item.category))
        return false
      if (difficulties.length > 0 && !difficulties.includes(item.difficulty))
        return false
      if (
        readBuckets.length > 0 &&
        !readBuckets.some((bucket) => inReadBucket(item.minutes, bucket))
      ) {
        return false
      }
      return true
  ...
  const counts = useMemo(
    () => makeCounts(scoredResults.map((result) => result.item)),
    [scoredResults],
  )
            ...
            <div className="search-results-layout mt-7">
              <FiltersSidebar
                ...
                onDifficultyToggle={(value) =>
                  toggleValue(value, difficulties, setDifficulties)
                }
                onReadBucketToggle={(value) =>
                  toggleValue(value, readBuckets, setReadBuckets)
                }
              />
              ...
              <div>
                ...
                {filteredResults.length === 0 ? (
                  <NoResults
                    onReset={() => choosePopularSearch('yoga for beginners')}
                  />
                ) : null}
                <Pagination
                  page={page}
    ...
    <section className="relative overflow-hidden bg-[color:var(--color-bg)]">
      ...
      <Container size="wide" className="relative">
        <div className="grid min-h-[390px] items-center pb-16 pt-14 md:grid-cols-[minmax(0,420px)_1fr] md:pb-12">
          <div>
            ...
            <p className="mt-7 max-w-sm text-base leading-8 text-[color:var(--color-ink-soft)]">
              Explore our guides, reviews, practices and philosophy to support
              your journey.
            </p>
          </div>
        </div>
        <div className="relative z-10" style={{ paddingBottom: '2rem' }}>
          ...
          >
            <Search
              className="ml-6 mt-5 h-6 w-6 shrink-0 text-[color:var(--color-ink-soft)]"
              strokeWidth={1.5}
            />
  ...
  return (
    <aside className="space-y-8">
      <FilterGroup title="Content type">
        {(
          ['All Results', ...CONTENT_TYPES] as Array<
            'All Results' | ContentType
          >
        ).map((type) => (
          <button
            key={type}
          ...
          >
            <span>{type}</span>
            <span>
              {type === 'All Results' ? counts.total : counts.types[type]}
            </span>
          </button>
        ))}
      </FilterGroup>
  ...
  return (
    ...
    >
      ...
      <div className="relative p-6 md:p-7">
        ...
        <p className="mt-4 max-w-xl text-sm leading-6 text-[color:var(--color-ink-soft)]">
          {item.excerpt}
        </p>
        <p className="mt-5 text-xs text-[color:var(--color-ink-muted)]">
          {item.minutes} min read <span aria-hidden="true">•</span>{' '}
          {item.difficulty}
        </p>
        <Bookmark
  ...
  return (
    <div className="rounded-md border border-[color:var(--color-border)] bg-[color:var(--color-surface)] p-8 text-center">
      ...
      <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-[color:var(--color-ink-soft)]">
        Try a broader search term, clear one of the filters or start with
        beginner yoga.
      </p>
      <button
        type="button"
...
function makeCounts(items: Array<SearchItem>) {
  return {
    ...
    readBuckets: Object.fromEntries(
      READ_BUCKETS.map((bucket) => [
        bucket,
        items.filter((item) => inReadBucket(item.minutes, bucket)).length,
      ]),
    ) as Record<ReadBucket, number>,
  }
}
