...
import { guideRecommendation } from '#/lib/guide-recommendation'
...
function GuidePage() {
  ...
  const recommendation = guideRecommendation(frontmatter)
  ...
  return (
    <>
      ...
      <section className="bg-[color:var(--color-bg)] pb-16 pt-12 md:pb-24 md:pt-16">
        <Container size="wide">
          <div className="grid min-w-0 gap-12 lg:grid-cols-12 md:gap-12 lg:gap-16">
            ...
            {/* Sidebar */}
            <aside className="min-w-0 max-w-full lg:col-span-4 lg:pl-4">
              {recommendation ? (
                <div className="hidden lg:block lg:sticky lg:top-24">
                  <SidebarProduct {...recommendation} />
                </div>
              ) : (
                <>
                  {/* About the Author */}
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="mt-2 text-sm leading-relaxed text-[color:var(--color-ink-muted)]">
                          Founder of The Yoga Sensei. Long-time practitioner,
                          not a certified instructor — every piece on this site
                          is written and edited by Marvin.
                        </p>
                      </div>
                    </div>
                    <Link
      ...
      {recommendation ? (
        <MobileProductBar key={slug} {...recommendation} />
      ) : null}
    </>
  )
}
