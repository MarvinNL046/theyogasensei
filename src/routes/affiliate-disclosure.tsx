...
export const Route = createFileRoute('/affiliate-disclosure')({
  head: () => ({
    meta: [
      ...
      {
        property: 'og:title',
        content: 'Affiliate Disclosure — The Yoga Sensei',
      },
      {
      ...
      {
        property: 'og:url',
        content: 'https://www.theyogasensei.com/affiliate-disclosure',
      },
      { property: 'og:type', content: 'website' },
      {
        property: 'og:image',
        content:
          'https://www.theyogasensei.com/images/brand/article-hero-morning-yoga.webp',
      },
    ...
    links: [
      {
        rel: 'canonical',
        href: 'https://www.theyogasensei.com/affiliate-disclosure',
      },
    ],
  }),
    ...
    <section className="bg-[color:var(--color-bg)] py-16 md:py-24">
      <Container size="narrow">
        ...
        <p className="mt-6 text-base leading-8 text-[color:var(--color-ink-soft)]">
          ...
          guides may include affiliate links. If you click one of those links
          and buy something, we may earn a commission at no extra cost to you.
        </p>
        ...
        <div className="mt-10 space-y-9 rounded-sm border border-[color:var(--color-border)] bg-[color:var(--color-surface)] p-6 shadow-sm md:p-9">
          <section>
            <h2 className="font-serif text-2xl">Current status</h2>
            <p className="mt-3 text-sm leading-7 text-[color:var(--color-ink-soft)]">
              ...
              links, the page will say so clearly near the top and the links
              will be marked with <code>rel="sponsored nofollow"</code>.
            </p>
          </section>

          <section>
            <h2 className="font-serif text-2xl">Programs we may use</h2>
            <p className="mt-3 text-sm leading-7 text-[color:var(--color-ink-soft)]">
              The Yoga Sensei may participate in retailer affiliate programs
              where relevant, including Amazon Associates if approved and
              active. When a specific program is used, the affected page will
              include the required program disclosure language near the relevant
              links.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-7 text-[color:var(--color-ink-soft)]">
              <li>
                We do not invent product testing, prices, ratings, or review
                counts.
              </li>
              <li>
                We do not call something “tested” unless Marvin has actually
                tested it.
              </li>
              <li>
                We do not recommend a product only because it has a commission.
              </li>
              <li>
                We prefer clear “who this is for / who should skip it” guidance
                over hype.
              </li>
            </ul>
          </section>
