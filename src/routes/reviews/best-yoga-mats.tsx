...
function ReviewsOverviewPage() {
  ...
  return (
    <>
      ...
      <div className="mx-auto grid max-w-[1400px] gap-8 px-4 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)] lg:px-8">
              ...
              <div className="grid gap-10 md:grid-cols-12">
                <div className="md:col-span-5">
                  ...
                  <p className="mt-6 text-base leading-relaxed text-[color:var(--color-ink-soft)]">
                    We assess every mat across five factors that change how it
                    feels in a real practice. The labels are editorial judgments
                    built from material research, published specifications and
                    clearly attributed independent evidence. They are not
                    measurements from a controlled lab, so we do not present
                    them as decimal scores.
                  </p>
                  <p className="mt-4 text-base leading-relaxed text-[color:var(--color-ink-soft)]">
                    ...
                    report. The picks come from three layers — stable product
                    specs, manufacturer documentation, and broad consensus
                    across serious review publications and practitioner
                    communities. It tells you what can be known from the
                    outside: material, thickness, construction, care, recurring
                    praise and recurring complaints.
                  </p>
                  <p className="mt-4 text-base leading-relaxed text-[color:var(--color-ink-soft)]">
                    We also separate <em>best</em> from <em>most premium</em>. A
                    mat can be the best beginner buy because it removes
                    friction, even if it isn&rsquo;t the one a teacher keeps for
                    ten years. So every pick is framed by use case first, then
                    material, then the trade-off — and live prices and review
                    counts, which change constantly, are kept out of evergreen
                    copy on purpose.
                  </p>
                </div>
                <div className="md:col-span-7">
                  <dl className="grid gap-px overflow-hidden rounded-sm border border-[color:var(--color-border)] bg-[color:var(--color-border)] sm:grid-cols-2">
                    ...
                    <div className="bg-[color:var(--color-surface)] p-6">
                      ...
                      <dd className="mt-1 text-sm leading-relaxed text-[color:var(--color-ink-muted)]">
                        A qualitative read of the five factors, weighted toward
                        the use case the mat is recommended for.
                      </dd>
                    </div>
                  </dl>
                </div>
        ...
        <aside className="hidden py-16 lg:block">
          <div className="sticky top-28">
            <SidebarProduct
              ...
              points={[
                '6mm closed-cell PVC',
                'Consider the carry weight and towel needs',
              ]}
            />
          </div>
        </aside>
      </div>
      <MobileProductBar slug="manduka-pro-6mm" productName="Manduka PRO 6mm" />
