...
export const DETAIL: DetailReview = {
  ...
  sections: [
    ...
    },
    {
      ...
      cta: {
        ...
        label:
          'If you want a decade rather than four to six years, this is the mat that carries a guarantee:',
      },
      rating: 4,
    },
  ],
  ...
  notIdealFor:
    'Skip it if you carry your mat daily, have a latex or rubber allergy, or want a mat that stays looking new — it is heavy, the top stains, and the grip softens over a few years.',
