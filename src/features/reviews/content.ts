/**
 * AUTO-GENERATED editorial detail content for the yoga-mat roundup.
 * Extracted from our own review/roundup MDX (content/guides/*) via a workflow
 * and adversarially fact-checked against those files. Scores live in data.ts.
 */
...
export const PICK_DETAILS: Record<string, PickDetail> = {
  ...
  "Liforme Classic (Original)": {
    ...
    "verdict": "A genuinely different pick: choose it when seeing where your body is matters more than raw grip or plush cushion. Best for beginners who like visual guidance, alignment-focused practice and home learners who benefit from placement cues. Skip it if latex sensitivity is an issue, you dislike visual markings on a mat, or you want a thick cushion-first surface.",
    "atAGlance": {
      "bestFor": "Alignment-focused practice",
      "grip": "Eco-PU top, responsive surface",
      "cushion": "4.2mm, stable not plush",
      "durability": "Eco-PU over natural rubber base"
    }
  },
  "Jade Harmony": {
    "whyPicked": "It's the classic natural-rubber pick — the mat teachers reach for when grip is the priority. Open-cell rubber grabs the floor and your skin directly, with no coating to wear off and no break-in, so it grips from the very first roll-out. Add a genuinely credible eco story (renewable, non-Amazon-harvested tree rubber, biodegradable, no PVC, made in the USA, a tree planted per mat) and you get the best natural-rubber choice for a dry home or studio practice.",
    "pros": [
    ...
    "verdict": "Buy the Jade Harmony if grip is your number-one priority and you mostly practise dry — gentle, hatha, vinyasa or restorative — and you want a genuinely eco, made-in-USA natural-rubber mat. For that practitioner it's close to ideal. Skip it if you do hot yoga or sweat heavily, have any latex sensitivity, or want a lifetime mat, since natural rubber is a multi-year material that biodegrades by design. Know its one real limit — sweat — and it's an easy recommendation.",
    "atAGlance": {
      "bestFor": "Dry home or studio practice",
      "grip": "Best-in-class when dry, weak when wet",
      "cushion": "Grounded everyday feel (~4.7mm)",
      "durability": "Moderate, multi-year (biodegrades)"
    }
  },
  "Gaiam Premium 6mm": {
    "whyPicked": "It earns the Best Value / Beginners spot because it lowers the decision pressure when you are starting out. A simple 6mm PVC mat gives enough cushion to begin without pretending it is the last mat you will ever buy. The 6mm compresses just enough to take pressure off knees, wrists and elbows during longer holds while your body adjusts, the prints make it a mat you actually want to roll out, and a low price plus a lifetime guarantee make trying yoga on one about as low-risk as it gets. It is the sensible choice for someone honest about starting from zero: buy a reasonable mat, build the routine, then upgrade once your practice tells you what you actually need.",
    "pros": [
  ...
  "Manduka eKO 5mm": {
    ...
    "verdict": "For people who want one substantial natural-rubber mat that balances cushion and grip, the eKO 5mm is the point. It is best for home practice and general vinyasa where you care about the surface more than portability. Skip it if you need light carry, dislike rubber smell, or need a latex-free mat.",
    "atAGlance": {
      "bestFor": "All-round cushion, home practice and general vinyasa",
      "grip": "Grippy natural rubber, tactile and grounded",
      "cushion": "Dense and supportive at 5mm",
      "durability": "Substantial serious-mat build (needs proper drying)"
    }
  },
  "Manduka eKO Lite 4mm": {
    "whyPicked": "This is the lighter natural-rubber option for when portability matters more than maximum cushion. It keeps the grippy rubber feel but drops some bulk, landing around 4mm thick and roughly 4.5 lb, which makes it far more realistic to carry than a dense 7 lb mat. If you commute to the studio, practise in a small space, or want something travel-adjacent without giving up the rubber surface, this is the pick that actually leaves the house with you.",
    "pros": [
    ...
    "verdict": "A genuine trade-off mat, and an honest one. The eKO Lite solves portability and keeps the rubber feel, but it doesn't pretend to be the most cushioned or most absorbent mat in the room. Buy it if you carry a mat often, practise in a small space, or want rubber underfoot without the heaviest haul. Skip it if you want maximum cushion, serious hot-yoga sweat handling, or a latex-free material.",
    "atAGlance": {
      "bestFor": "Travel, commuters and small-space practice",
      "grip": "Tactile natural-rubber feel",
      "cushion": "4mm, close to the floor but more than ultra-thin travel sheets",
      "durability": "Natural rubber; like other rubber mats it needs proper drying and gentle care"
    }
  }
}

export interface BuyingPoint { title: string; body: string }

export const BUYING_GUIDE: { intro: string; points: BuyingPoint[] } = {
  "intro": "There is no single best yoga mat, only the one that fits your body, your practice style, and how often you have to carry it. The notes below walk through the trade-offs that actually matter on the floor, so you can choose without chasing false certainty.",
  "points": [
    {
      "title": "Material decides feel, grip, and care",
      "body": "Closed-cell PVC (like the Manduka PRO) is durable and easy to wipe down but can feel slick and needs a break-in period, while natural rubber feels grippier and more grounded at the cost of weight, an initial smell, and more careful drying. PU-topped mats grip best under damp hands but ask for the most diligent cleaning."
    },
    {
      "title": "Thickness: 4-6mm, and more is not automatically better",
      "body": "Most practitioners are best served comparing 4mm, 5mm, and 6mm rather than reaching for extra-thick foam: 4mm feels stable and portable, 5mm is the all-round middle, and 6mm adds cushion for knees but can make standing balance feel vague. Pick the number you will practise on consistently, not the highest one."
    },
    {
      "title": "Solve wet grip before anything else for hot yoga",
      "body": "If you sweat heavily, traction once the surface is damp matters more than cushion, which is why a sweat-specific PU top (like the GRP Adapt) beats a basic dry-grip mat. Pair it with a towel and accept that the thickest mat is rarely the best mat in a heated room."
    },
    {
      "title": "Match size and weight to how you actually get to class",
      "body": "Heavier mats often lie flatter and feel more planted, so weight is not automatically a flaw; the problem is mismatch. A dense ~7lb mat is fine if it lives beside your practice space, but becomes a real barrier if every session means a commute, so weigh portability honestly before falling for a premium build."
    },
    {
      "title": "Buy for the practice you have, not the one you imagine",
      "body": "If you are starting out, a simple cushioned mat (such as the Gaiam Premium 6mm) removes friction and lets you build the habit before upgrading once your practice tells you what it needs. Spending the most up front is rarely wise before you know whether you prefer slow hatha, vinyasa, or restorative work."
    },
    {
      "title": "Flag latex and skin sensitivity early",
      "body": "Natural rubber and rubber-base mats (Liforme, Jade Harmony, both Manduka eKOs) are not neutral for latex-sensitive practitioners, so the safe move is to choose a latex-free option from the start rather than gamble. Plan care too: drying fully, avoiding harsh cleaners, and keeping the mat out of direct sun all extend its life."
    }
  ]
}

export const REVIEW_FAQS: { q: string; a: string }[] = [
  {
    "q": "What is the best yoga mat for beginners?",
    "a": "For many beginners, the Gaiam Premium 6mm is the easiest starting point: it gives cushion, manageable weight and a low-pressure entry into practice. It is not the highest-performance mat in this guide, and that is fine — a beginner mat should help you build consistency before you over-optimise. If you already know you want a more serious natural-rubber feel, look at the Manduka eKO 5mm instead; it is heavier but gives a denser, more grounded surface."
  },
  {
    "q": "How thick should a yoga mat be?",
    "a": "Most people should start between 4mm and 6mm. Around 4mm feels stable and easier to carry, 5mm is the all-round middle, and 6mm gives more cushion for knees and slower practice. Very thick foam can feel comfortable at first but unstable in standing poses. The right thickness depends on your joints, balance, practice style and whether you carry the mat — so don't choose purely by millimetres."
  },
  {
    "q": "Are natural rubber mats better than PVC?",
    "a": "Natural rubber is often better if you want tactile grip, a grounded feel and less of a plastic surface — but it isn't automatically better for everyone. Rubber can smell at first, needs careful drying, weighs more and matters for latex-sensitive practitioners. PVC can be durable, closed-cell and simpler to wipe down (the Manduka PRO is the premium version of that logic, the Gaiam Premium the beginner-friendly one). Choose by use case, not material ideology."
  },
  {
    "q": "How do I clean a new yoga mat?",
    "a": "Start gently. Wipe the surface with a damp cloth, let the mat air-dry fully, and follow the manufacturer's care guidance before using sprays, soap or vinegar. Avoid harsh cleaners, soaking and direct sunlight unless the brand specifically recommends them. Material matters too — rubber, PVC, polyurethane and cork don't all want the same routine."
  },
  {
