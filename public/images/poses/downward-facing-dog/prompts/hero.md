# Hero — poses/downward-facing-dog (Aiko in the pose)
...
- **Use:** pose hero (route background + inline Figure). Photographic Aiko in the actual pose — the brand's pose-image style (decorative persona, see [[Aiko-Persona]]), NOT a claimed certified instructor.
