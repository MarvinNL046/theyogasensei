...
<ProductSpecStrip productName="Gaiam Premium 6mm" slug="gaiam-premium-6mm" specs={{ thickness: '6 mm', weight: '3.3 lb (measured)', material: 'PVC (6P-free)', latexFlag: false }} />
...
<ProductSpecStrip productName="Jade Harmony" slug="jade-harmony" specs={{ thickness: '5 mm', weight: '~5 lb', material: 'Natural rubber', latexFlag: true, notes: 'Natural rubber is latex-relevant; keep it out of direct sun and heat.' }} />
...
<ProductSpecStrip productName="Liforme Original" slug="liforme-original" specs={{ thickness: '4.2 mm', weight: '~5.5 lb', material: 'Eco-PU top + natural rubber base', latexFlag: true, notes: 'Alignment guide-lines help beginners; natural-rubber base is latex-relevant; pair with a knee pad if you need more cushion.' }} />
...
<ProductSpecStrip productName="Manduka PRO 6mm" slug="manduka-pro-6mm" specs={{ thickness: '6 mm', weight: '~7.5 lb', material: 'PVC (closed-cell)', latexFlag: false, notes: 'Needs a short grip break-in when new; lifetime guarantee (terms apply).' }} />
