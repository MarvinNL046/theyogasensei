...
Start with the trade-off, because it decides everything else. More foam under the knee feels protective in kneeling and low poses. The same foam works against you the moment you balance: the foot sinks, the surface gives unevenly, and the small stabilising muscles get noisier feedback. That is why a very squishy mat can feel kind to your knees and shaky in _Vrksasana_ (Tree Pose) at the same time.
...
<CushionStabilitySpectrum caption="Soft foam protects the knee but gives way under a standing foot; a thin mat is stable but punishing to kneel on. Density is the lever most buyers miss — a dense 6mm mat pads the knee without collapsing when you stand." />
...
The Gaiam Premium 6mm is the sensible budget answer when you want knee cushion without committing to a premium mat. It is a 6mm PVC mat (6P-free) at 3.3 lb — OutdoorGearLab's measurement, because Gaiam publishes none — so it gives meaningful padding while staying light enough to move and store easily. For someone who mainly needs a softer surface under the knees and is not ready to spend big, it removes the friction — the [full Gaiam yoga mat review](/reviews/gaiam) covers its length and Prop 65 caveats.
...
<ProductSpecStrip
  productName="Liforme Original"
  specs={{
    thickness: '4.2 mm',
    weight: '~5.5 lb',
    material: 'Eco-PU top + natural rubber base',
    latexFlag: true,
    notes:
      'Natural rubber base is latex-relevant; thinner mat, pair with a knee pad if you need extra cushion for kneeling.',
  }}
/>
...
<Figure
  id="guides/best-yoga-mat-for-bad-knees/same-6mm-different-density"
  alt="Two mats of identical thickness side by side, a finger sinking deep into the left one while the right barely yields"
  caption="Both these mats measure the same at the edge. One collapses under a fingertip and one does not — that difference is density, and it is what your knee actually feels."
/>
...
<Figure
  ...
  alt="A yoga mat with its end folded back double for extra thickness, and a folded towel laid on another section"
  caption="Two of the fixes below, costing nothing. Try these for a week before you replace a mat that may be fine everywhere except one pose."
/>
...
- **Add a folded towel or blanket.** A rolled towel under the kneecap in _Anjaneyasana_ or table-top poses is the oldest fix in the studio for a reason. It is free and it works.
- **Use a dedicated knee pad.** Small foam kneeling pads cost a few euros and travel easily. They pair especially well with a thinner, grippier mat like the Liforme. Our [yoga knee pad guide](/guides/best-yoga-knee-pads) covers which thickness suits which problem — and why a blanket folded to an inch matches the thickest pads sold.
...
Be more careful if your practice is balance-heavy or fast. In standing flows, _Vinyasa_ and balance work, too much soft cushion makes the floor feel uncertain and can make you work harder to stay steady. If that is most of your practice, a thinner, denser mat plus a knee pad for the occasional kneeling pose is often the smarter setup than a [thick foam mat like the Retrospec Solana](/reviews/retrospec).
...
- [Yoga knee pads](/guides/best-yoga-knee-pads) — targeted padding for the four or five poses where the problem actually is.
- [Yoga blocks](/guides/best-yoga-blocks) — height and support that can take load off a kneeling joint.
- [Yoga bolsters](/guides/best-yoga-bolster) — firm support for restorative and reclined practice.
- [Mat bags and carriers](/guides/best-yoga-mat-bag) — for carrying the mat to class.

If the mat is fine and it is only kneeling that hurts, the pad is the cheaper answer. This is the one we default to:

<AffiliateButton
  slug="prosourcefit-knee-pad"
  productName="ProsourceFit Extra Thick Knee Pad"
/>
...
- [Best yoga mats of 2026](/reviews/best-yoga-mats) — the wider shortlist across every mat type, not just knee comfort.
