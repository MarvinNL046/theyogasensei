...
If you have settled on the cushioned end of the range, compare actual dense and soft-foam options in the [best thick yoga mat guide](/guides/best-thick-yoga-mat).
...
<Figure
  id="guides/how-thick-should-a-yoga-mat-be/density-under-load"
  alt="A knee pressing into a thick soft foam mat that compresses almost flat, beside a knee on a thin dense mat that barely indents"
  caption="Millimetres are only half the answer. Thick soft foam can bottom out under a knee while a thinner dense mat holds — which is why the spec sheet alone will not tell you how a mat feels."
/>
...
A dense **4mm (about 5/32 inch)** mat can feel more supportive than a soft **6mm (about 1/4 inch)** mat because it does not collapse under your knee. A cheap plush foam mat — the [Retrospec Solana](/reviews/retrospec) is a classic example — may look comfortable in photos but feel unstable in lunges and compress quickly under repeated use.
...
<Figure
  id="guides/how-thick-should-a-yoga-mat-be/mat-on-carpet"
  alt="The same yoga mat shown on soft carpet where it sinks and rippling appears, and on a hard wooden floor where it lies flat"
  caption="The floor underneath changes the answer. On carpet you already have padding and a thick mat starts to feel unstable; on tile or wood you do not."
/>
...
<Figure
  id="guides/how-thick-should-a-yoga-mat-be/knee-pad-instead"
  alt="A woman kneeling on a thin yoga mat with a small foam pad placed under her knees only"
  caption="The setup this section argues for: a thin stable mat for everything, plus padding only where the pressure actually is."
/>
...
A pad also costs a fraction of a thicker mat and does not change how every standing pose feels. Our [yoga knee pad guide](/guides/best-yoga-knee-pads) goes through the thicknesses and the free alternatives; if you just want the one that works, this is it.
