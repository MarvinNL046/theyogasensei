...
pin:
  primaryImage: yoga-mats/how-to-clean-a-yoga-mat/pin-a
...
howTo:
  ...
  step:
    ...
    - name: Hang the mat to air-dry for 24 hours
      text: Drape it over a shower rod, drying rack or chair back, out of direct sunlight. A small fan speeds drying without heat. Roll the mat loosely only once it is fully dry — trapped moisture causes mildew.
faq:
...
**Lifespan.** Regular care can double or triple how long a mat lasts. Manduka famously offers a lifetime guarantee on the PRO when it is cared for properly — the same mat, never wiped down and rolled up wet, can be unusable inside a year.
...
This is where you go gentler with closed-cell mats and more carefully with open-cell ones.
...
For more on how long a properly maintained mat should actually last, see our complete yoga mat buying guide (publishing soon).
