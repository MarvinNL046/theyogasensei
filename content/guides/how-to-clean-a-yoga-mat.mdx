...
howTo:
  totalTime: PT15M
  step:
    - name: Unroll the mat flat and shake off debris
      text: Lay your mat flat on a clean floor. Sweep or shake off any hair, dust or loose dirt before you start. Wiping a dirty mat just rubs grit into the surface.
    - name: Lightly dampen a microfiber cloth
      text: Use a cloth that is damp, not wet. For a daily clean plain water is enough. For a weekly clean use a diluted vinegar or witch hazel spray.
    - name: Wipe both sides in slow sweeping passes
      text: Start with the top side, working from one end of the mat to the other. Then flip and do the back. Pay extra attention to the high-contact zones where your hands, feet and forehead land.
    - name: Hang the mat to air-dry fully
      text: Drape it over a shower rod, drying rack or chair back. Give it at least an hour for a daily wipe-down and twenty-four hours after a deeper clean.
    - name: Roll the mat loosely only after it is dry
      text: Rolling a damp mat traps moisture inside and is the fastest route to mildew, lasting odour and a slippery top layer. Dry first, always.
faq:
...
**Lifespan.** Regular care can double or triple how long a mat lasts. A well-treated Manduka PRO realistically gives you ten years. The same mat, never wiped down and rolled up wet, can be unusable inside a year.
...
For more on how long a properly maintained mat should actually last, see [our complete yoga mat buying guide](/guides/yoga-mat-buying-guide) (publishing soon).
...
- Stick to a light damp cloth with at most a drop of mild soap. Lululemon's published care guidance is consistent on this: no soaking, no harsh chemicals.
- If you cannot find their current care page, default to the gentlest possible approach — water and microfiber.
...
- **Important**: always follow with a clean damp cloth to wipe off any soap residue. Skipping this step is one of the most common mistakes I see — and it leaves a film that kills your grip.
...
- [REI Expert Advice: How to Clean Your Yoga Mat](https://www.rei.com/learn/expert-advice/yoga-mat-cleaning.html) — a short, well-sourced primer covering the basics
