...
Polyurethane-top mats are popular because they can grip well when damp. [Lululemon's The Mat](/reviews/lululemon) is the common reference point for this category: a grippy top surface bonded to a rubber base. Liforme-style mats also use a grippy top layer over a rubber base, though the exact construction depends on the model.
